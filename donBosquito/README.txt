...
a persistence unit "donBosquitoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "donBosquito\pom.xml":
...
artifact ("donBosquito.war") is already built. You can build
